...
namespace ConsolePlaneet9feb2024
{
    internal class Program
    {
        private static void Bereken(WeightInKilogram7feb2024 gewichtOpAarde)
        {
            ...
            {
                gewichtOpDiePlaneet[k] = (omzetting[k] * gewichtOpAarde).GetInKilogram();
            }
        ...
        private static void Main(string[] args)
        {
            ...
            {
                var weightOnEarth = new WeightInKilogram7feb2024(gewichtOpAarde);
