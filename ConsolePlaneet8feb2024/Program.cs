...
namespace ConsolePlaneet8feb2024
{
    internal class Program
    {
        private static void Bereken(IWeight7feb2024 gewichtOpAarde)
        {
            ...
            {
                gewichtOpDiePlaneet[k] = gewichtOpAarde.MultiplyBy(omzetting[k]).GetInKilogram();
            }
        ...
        private static void Main(string[] args)
        {
            ...
            {
                IWeight7feb2024 weightOnEarth = new WeightInKilogram7feb2024(gewichtOpAarde);
                Bereken(weightOnEarth);
            }
